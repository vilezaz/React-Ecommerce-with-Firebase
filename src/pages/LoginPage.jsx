...
import { loginUser, signInWithGoogle } from '../store/Slices/auth';
      ...
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit" 
            disabled={loading}
            className={`w-full p-3 rounded-lg text-white font-semibold text-lg transition duration-300 ${
              loading 
          ...
          <button 
            ...
            className="w-full cursor-pointer flex items-center justify-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-300"
          >
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            ...
            <Link to="/register" className="font-semibold mx-2 text-blue-600">
              Create one here
            </Link>
          </p>
        </div>
